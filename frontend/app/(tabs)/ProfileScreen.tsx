    ...
    <SafeAreaView className='flex-1 bg-background items-center justify-start'>
      ...
      >
        ...
        <View className='mt-[50px]'>
          <TouchableOpacity onPress={() => alert('This will allow User to change their profile picture')} activeOpacity={0.85}>
        ...
        {/* Statistics */}
        {/* Placeholder for now */}
        <TouchableOpacity onPress={() => handleStatisticsPress()} activeOpacity={0.85}>
